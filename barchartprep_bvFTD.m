...
rootdir = '/Volumes/macdata/groups/rankin/Users/Myrthe/2019/rSMS_DCM/RSMS-DCM/models/SN_bilateral/SN_bvFTD_bi/DCM_results';


% Set parameters
THRESHOLD = 0.99;
GROUPSELECTOR = 'bvFTD';
savefile = ['bargraph_bvFTD' GROUPSELECTOR '.csv'];
